...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.qos.Strategy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StrategyItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QosPackage.Literals.STRATEGY__STRATEGY_VALUES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Strategy.class)) {
			case QosPackage.STRATEGY__STRATEGY_VALUES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QosPackage.Literals.STRATEGY__STRATEGY_VALUES,
				 QosFactory.eINSTANCE.createGroupComponent()));
	}
